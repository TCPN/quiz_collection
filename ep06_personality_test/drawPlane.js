 ...
 * ```
 */
function drawPlane(container, points = [], opts = {}) {
  ...
  function drawArrowLine(svg, x1, y1, x2, y2) {
    const line = document.createElementNS(svgNS, 'line');
  ...
  function drawTextLabel(svg, x, y, text, { align = 'c', fontSize = 13, margin = fontSize / 2, fontWeight = '600', fill = '#000', stroke = '', strokeWidth = stroke ? 1 : 0 } = {}) {
   ...
   */
  function getAlign(size, anchor, bound) {
    const space = {
